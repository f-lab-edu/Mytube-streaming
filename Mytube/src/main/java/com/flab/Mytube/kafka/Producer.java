...
public class Producer {
  ...
  public CompletableFuture<SendResult<String, String>> sendMessage(String rootpath){
//    ProducerRecord<String, String> record = new ProducerRecord<>("videoEncoding", rootpath);
    final ProducerRecord<String, String> record = new ProducerRecord("videoEncoding", rootpath);
...
//  }
  ...
  public void sendPath(final String topic,final String path){
